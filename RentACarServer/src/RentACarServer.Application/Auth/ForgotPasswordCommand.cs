...
namespace RentACarServer.Application.Auth
{
    ...
    public sealed class ForgotPasswordCommandValidator : AbstractValidator<ForgotPasswordCommand>
    {
        ...
        {
            RuleFor(p => p.Email).NotEmpty().WithMessage("Write a valid mail").EmailAddress()
                .WithMessage("Write a valid mail");
        }
    }
    ...
    public sealed class ForgotPasswordCommandHandler(IUserRepository userRepository, IUnitOfWork unitOfWork, IMailService mailService) : IRequestHandler<ForgotPasswordCommand, Result<string>>
    {
        ...
        {
            var user = await userRepository.FirstOrDefaultAsync(p => p.Email.email == request.Email, cancellationToken);
            if (user is null)
            {
...
<body>
    ...
    <table role=""presentation"" cellspacing=""0"" cellpadding=""0"" border=""0"" width=""100%"" style=""background-color: #f9f9f9;"">
        <tr>
                            ...
                            <div class=""container"">
                                ...
                                <div class=""content"">
                                    ...
                                    <div class=""button-container"">
                                        <a href=""{ResetPasswordUrl}"" class=""button"">Şifremi Sıfırla</a>
                                    </div>
            ...
            body = body.Replace("{UserName}", user.FirstName.name + " " + user.LastName.lastname);
            string resetPasswordUrl = $"https://localhost4200/reset-password/{user.ForgotPasswordId!.Value}";
